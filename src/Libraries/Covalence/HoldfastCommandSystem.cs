...
namespace Oxide.Game.Holdfast.Libraries.Covalence
{
    ...
    /// </summary>
    public class HoldfastCommandSystem : ICommandSystem
    {
        #region Initialization

        // The console player
        internal HoldfastConsolePlayer consolePlayer;
        ...
        public HoldfastCommandSystem()
        {
            ...
            consolePlayer = new HoldfastConsolePlayer();
        }
